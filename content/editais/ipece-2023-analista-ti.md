...
carreira:
  ...
  niveis: 12
  progressao_horizontal: "Progressão por desempenho a cada 3 anos"
  progressao_vertical: "Promoção por titulação e avaliação"
...
- **Remuneração total inicial: R$ 16.884,27** (vencimento R$ 5.428,69 + GDAP R$ 11.417,05)
- **Com GDAP máxima: R$ 20.651,42** (última ref. da tabela)
- GDAP representa ~67% da remuneração total — gratificação muito expressiva
- Estabilidade de servidor estadual CE

### Pontos de Atenção

- GDAP é gratificação de desempenho — valor inicial é 75% do teto, mas pode oscilar
- Baixa flexibilidade de horário e home office limitado
- Adicional de titulação incide apenas sobre vencimento base (impacto menor)
- Dados de plano de saúde e vagas ainda pendentes de confirmação

### ⚠️ Dados Pendentes

- [ ] Link direto para o edital PDF (`edital_link`)
- [ ] Número exato de vagas (`vagas_total`)
- [ ] Valor do auxílio saúde (`beneficios.aux_saude`)
- [ ] Detalhes do plano de saúde (`beneficios.plano_saude`)
